package com.example.unit9menusrecorded;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {  Intent settingsIntent = new Intent(this, SettingsActivity.class);
        startActivity(settingsIntent);
            return true;
        }
        if (id == R.id.action_sms) { Intent smsIntent = new Intent (Intent.ACTION_SEND);
            smsIntent.setType("*/*");
        ...
        if (id == R.id.action_delete) {Snackbar.make(getWindow().getDecorView(), "Delete", Snackbar.LENGTH_LONG)
                .setAction("Action", null).show();
            return true;
        }
